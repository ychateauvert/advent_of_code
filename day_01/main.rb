...
#contents = File.read("input.txt").split(", ").map { |i| Direction.new(i) }
##contents = %w{ R5 L5 R5 R3  }.map { |i| Direction.new(i) }
#seeker = Seeker.new
#final = seeker.follow(contents)
#puts "Shortest distance: #{final.shortest_distance}"
